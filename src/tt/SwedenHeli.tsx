                      ...
                      <td>
                        <div className="tree-item">
                          ...
                          <div className="tree-item-img">
                            <img
                              src="https://encyclopedia.warthunder.com/slots/hkp3c.png"
                              alt="hkp3c.png"
                            />
                          </div>
                        </div>
                    ...
                    <tr>
                      <td>
                        <div className="tree-item">
                          ...
                          <div className="tree-item-img">
                            <img
                              src="https://encyclopedia.warthunder.com/slots/hkp2.png"
                              alt="hkp2.png"
                            />
                          </div>
                        </div>
            ...
            <tr>
                    ...
                    <tr>
                      <td>
                        <div className="tree-item">
                          ...
                          <div className="tree-item-img">
                            <img
                              src="https://encyclopedia.warthunder.com/slots/hkp9a_cb2.png"
                              alt="hkp9a_cb2.png"
                            />
                          </div>
                        </div>
                    ...
                    <tr>
                      <td>
                        <div className="tree-item">
                          ...
                          <div className="tree-item-img">
                            <img
                              src="https://encyclopedia.warthunder.com/slots/hkp9a_cb3_fc.png"
                              alt="hkp9a_cb3_fc.png"
                            />
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div className="tree-item">
                          ...
                          <div className="tree-item-img">
                            <img
                              src="https://encyclopedia.warthunder.com/slots/ahs.png"
                              alt="ahs.png"
                            />
                          </div>
                        </div>
              ...
              <td style={{ borderLeft: "solid 1px #cccccc" }}>
                <div className="tree-item">
                  ...
                  <div className="tree-item-img">
                    <img
                      src="https://encyclopedia.warthunder.com/slots/mi_28a_sweden.png"
                      alt="mi_28a_sweden.png"
                    />
                  </div>
                </div>
              </td>
