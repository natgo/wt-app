    ...
    <div className="weapons" >
      {
        weapons?.cannon?.map((element,index) => {
          ...
          if (Array.isArray(element.horizonalLimit) && element.horizonalLimit[0] + element.horizonalLimit[1] === 0 && element.horizonalLimit[1] === 180) {
            horizontalLimit = "360°";
          } else if (Array.isArray(element.horizonalLimit) && element.horizonalLimit[0] + element.horizonalLimit[1] === 0) {
